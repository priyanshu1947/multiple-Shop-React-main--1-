      ...
      <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div className="row px-xl-5 pt-5">
          <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p className="mb-4">
            Connect with us – your feedback and inquiries are always welcome!
            </p>
          ...
          <div className="col-lg-8 col-md-12">
            <div className="row">
              ...
              <div className="col-md-4 mb-5">
                ...
                <p>Stay updated with the latest trends and exclusive offers. Subscribe to our newsletter for exciting updates, special promotions, and more. Your inbox deserves something specia</p>
                <form action="">
          ...
          <div className="col-md-6 px-xl-0">
            <p className="mb-md-0 text-center text-md-left text-secondary">
              ...
              <a
                ...
                href="https://www.youtube.com/channel/UCOvxBONcR2tHE1ISGPRNNDg"
              >
                Priyanshu kumar student at VIT
              </a>
            </p>
          </div>
